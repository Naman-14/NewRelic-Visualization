...
export default class HomeNerdlet extends React.Component {
  render() {
    return <>
    <p style={{color: "pink", padding:"10px", alignitem:"center", background:"Salmon", fontSize:"20px", textAlign:"center"}}>Hi Naman, This is your LineChart</p>
    <p style={{color: "pink", padding:"10px", alignitem:"center", background:"Salmon", fontSize:"20px", textAlign:"center"}}>This is LineChart</p>
    <LineChart style={{width:"50%", height:"35%"}}
    accountId = {3932072}
    ...
    <p style={{color: "skyblue", padding:"10px" , alignitem:"center", background:"Blue", fontSize:"20px", textAlign:"center"}}>This is LineChart</p>
    <LineChart style={{width:"50%", height:"35%"}}
    accountId = {3932072}
